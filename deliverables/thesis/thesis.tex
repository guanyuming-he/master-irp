...
information retrieved by my tool and other mainstream LLMs \& search engines
are compared.
...
data is probably not reproducible.
\begin{figure}[hbtp!]
	\centering
	\includegraphics[height=.3\textheight]{res/doc_host_dist.png}
