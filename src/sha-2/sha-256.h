/**
 * The file is not written by me. It is an external minimal library of SHA256
 * written by Alain Mosnier at https://github.com/amosnier/sha-2.
 *
 * (C) 2021 Alain Mosnier
 * The file is licensed under the Zero Clause BSD License.
 */
